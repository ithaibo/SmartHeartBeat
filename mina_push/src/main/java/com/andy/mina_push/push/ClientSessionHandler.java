...
public class ClientSessionHandler extends IoHandlerAdapter {
    ...
    public void exceptionCaught(IoSession session, Throwable cause) throws Exception {
        ...
        if(pushEventListener!=null) {
            pushEventListener.onPushExceptionCaught(session, cause);
        }
    }
    ...
    public void messageReceived(IoSession session, Object message) throws Exception {
        ...
        Log.i(this.getClass().getSimpleName(), "received msg: " + message);
        if(pushEventListener!=null){
            pushEventListener.onPushMessageReceived(message);
        }
    }
    ...
    public void messageSent(IoSession session, Object message) throws Exception {
        ...
        if(pushEventListener!=null){
            pushEventListener.onPushMessageSent(message);
        }
    }
