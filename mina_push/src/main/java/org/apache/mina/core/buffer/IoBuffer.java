 ...
 * {@link java.nio.ByteBuffer} documentation for preliminary usage. MINA does not use NIO
 * {@link java.nio.ByteBuffer} directly for two reasons:
 * <ul>
 ...
 * </pre>
 *
 * The underlying {@link java.nio.ByteBuffer} is reallocated by {@link IoBuffer} behind
...
public abstract class IoBuffer implements Comparable<IoBuffer> {
     ...
     * {@link java.nio.BufferOverflowException} instead of an {@link java.io.IOException} in case
    ...
    /**
     * Writes the specified {@link java.util.Set} to the buffer as a byte sized bit
     * vector.
     *
     * @param <E>
    ...
    /**
     * Writes the specified {@link java.util.Set} to the buffer as a short sized bit
     * vector.
     *
     * @param <E>
     *            the enum type of the Set
    ...
    /**
     * Writes the specified {@link java.util.Set} to the buffer as an int sized bit
     * vector.
     *
     * @param <E>
     *            the enum type of the Set
    ...
    /**
     * Writes the specified {@link java.util.Set} to the buffer as a long sized bit
     * vector.
     *
     * @param <E>
     *            the enum type of the Set
