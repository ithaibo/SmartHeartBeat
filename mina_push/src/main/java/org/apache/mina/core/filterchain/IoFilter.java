...
/**
 * A filter which intercepts {@link org.apache.mina.core.service.IoHandler} events like Servlet
 ...
 * {@link org.apache.mina.core.session.IoSession}s.</strong> Users can cache the reference to the
 ...
 *   <li>{@link #onPreAdd(IoFilterChain, String, org.apache.mina.core.filterchain.IoFilter.NextFilter)} is invoked to notify
 ...
 *   <li>{@link #onPostAdd(IoFilterChain, String, org.apache.mina.core.filterchain.IoFilter.NextFilter)} is invoked to notify
 ...
 * <ol>
 *   <li>{@link #onPreRemove(IoFilterChain, String, org.apache.mina.core.filterchain.IoFilter.NextFilter)} is invoked to
 ...
 *   <li>{@link #onPostRemove(IoFilterChain, String, org.apache.mina.core.filterchain.IoFilter.NextFilter)} is invoked to
...
public interface IoFilter {
     ...
     * @param nextFilter the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter.  You can reuse
    ...
    /**
     * Filters {@link org.apache.mina.core.service.IoHandler#sessionCreated(org.apache.mina.core.session.IoSession)} event.
     *
     * @param nextFilter
     *            the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter. You can reuse this
     *            object until this filter is removed from the chain.
     * @param session
     *            The {@link org.apache.mina.core.session.IoSession} which has received this event
     */
    void sessionCreated(NextFilter nextFilter, IoSession session) throws Exception;

    /**
     * Filters {@link org.apache.mina.core.service.IoHandler#sessionOpened(org.apache.mina.core.session.IoSession)} event.
     *
     * @param nextFilter
     *            the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter. You can reuse this
     *            object until this filter is removed from the chain.
    ...
    /**
     * Filters {@link org.apache.mina.core.service.IoHandler#sessionClosed(org.apache.mina.core.session.IoSession)} event.
     *
     * @param nextFilter
     *            the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter. You can reuse this
     *            object until this filter is removed from the chain.
    ...
    /**
     * Filters {@link org.apache.mina.core.service.IoHandler#sessionIdle(org.apache.mina.core.session.IoSession, org.apache.mina.core.session.IdleStatus)} event.
     *
     * @param nextFilter
     *            the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter. You can reuse this
     *            object until this filter is removed from the chain.
     ...
     *            The {@link org.apache.mina.core.session.IoSession} which has received this event
     * @param status
     *            The {@link org.apache.mina.core.session.IdleStatus} type
     */
    void sessionIdle(NextFilter nextFilter, IoSession session, IdleStatus status) throws Exception;

    /**
     * Filters {@link org.apache.mina.core.service.IoHandler#exceptionCaught(org.apache.mina.core.session.IoSession, Throwable)} event.
     *
     * @param nextFilter
     *            the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter. You can reuse this
     *            object until this filter is removed from the chain.
    ...
    /**
     * Filters {@link org.apache.mina.core.service.IoHandler#inputClosed(org.apache.mina.core.session.IoSession)} event.
     *
     * @param nextFilter
     *            the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter. You can reuse this
     *            object until this filter is removed from the chain.
    ...
    /**
     * Filters {@link org.apache.mina.core.service.IoHandler#messageReceived(org.apache.mina.core.session.IoSession, Object)} event.
     *
     * @param nextFilter
     *            the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter. You can reuse this
     *            object until this filter is removed from the chain.
    ...
    /**
     * Filters {@link org.apache.mina.core.service.IoHandler#messageSent(org.apache.mina.core.session.IoSession, Object)} event.
     *
     * @param nextFilter
     *            the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter. You can reuse this
     *            object until this filter is removed from the chain.
     ...
     *            The {@link org.apache.mina.core.session.IoSession} which has received this event
     * @param writeRequest
     *            The {@link org.apache.mina.core.write.WriteRequest} that contains the sent message
     */
    void messageSent(NextFilter nextFilter, IoSession session, WriteRequest writeRequest) throws Exception;

    /**
     * Filters {@link org.apache.mina.core.session.IoSession#close()} method invocation.
     *
     * @param nextFilter
     *            the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter. You can reuse this
     *            object until this filter is removed from the chain.
     * @param session
     *            The {@link org.apache.mina.core.session.IoSession} which has to process this method
     *            invocation
     */
    void filterClose(NextFilter nextFilter, IoSession session) throws Exception;

    /**
     * Filters {@link org.apache.mina.core.session.IoSession#write(Object)} method invocation.
     *
     * @param nextFilter
     *            the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} for this filter. You can reuse this
     *            object until this filter is removed from the chain.
     * @param session
     *            The {@link org.apache.mina.core.session.IoSession} which has to process this invocation
     * @param writeRequest
     *            The {@link org.apache.mina.core.write.WriteRequest} to process
     */
