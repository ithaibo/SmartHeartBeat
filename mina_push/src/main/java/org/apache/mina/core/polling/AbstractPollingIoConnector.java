 ...
 * connecting and disposing the client sockets. A {@link java.util.concurrent.Executor} will be used
...
public abstract class AbstractPollingIoConnector<T extends AbstractIoSession, H> extends AbstractIoConnector {
     ...
     * default session configuration, a default {@link java.util.concurrent.Executor} will be created
     * using {@link java.util.concurrent.Executors#newCachedThreadPool()}.
     *
     ...
     * events. If null {@link java.util.concurrent.Executor} is provided, a default one will be
    ...
    /**
     * Create a new client socket handle from a local {@link java.net.SocketAddress}
    ...
    /**
     * connect a newly created client socket handle to a remote {@link java.net.SocketAddress}.
    ...
    /**
     * {@link java.util.Iterator} for the set of client sockets found connected or failed
    ...
    /**
     * {@link java.util.Iterator} for all the client sockets polled for connection.
     ...
     * @param request the associated {@link org.apache.mina.core.polling.AbstractPollingIoConnector.ConnectionRequest}
     * @throws Exception any exception thrown by the underlying systems calls
     */
    protected abstract void register(H handle, ConnectionRequest request) throws Exception;

    /**
     * get the {@link org.apache.mina.core.polling.AbstractPollingIoConnector.ConnectionRequest} for a given client socket handle
