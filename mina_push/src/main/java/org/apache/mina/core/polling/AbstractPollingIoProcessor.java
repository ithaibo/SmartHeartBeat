...
import org.apache.mina.socket.AbstractDatagramSessionConfig;
...
public abstract class AbstractPollingIoProcessor<S extends AbstractIoSession> implements IoProcessor<S> {
     ...
     * {@link #write(AbstractIoSession, org.apache.mina.core.buffer.IoBuffer, int)} returns non-zero value.
     ...
     * {@link java.util.concurrent.Executor} for handling I/Os events.
     *
     * @param executor
     *            the {@link java.util.concurrent.Executor} for handling I/O events
     */
    ...
    /**
     * Get an {@link java.util.Iterator} for the list of {@link IoSession} polled by this
     * {@link IoProcessor}
     *
     * @return {@link java.util.Iterator} of {@link IoSession}
     */
    protected abstract Iterator<S> allSessions();

    /**
     * Get an {@link java.util.Iterator} for the list of {@link IoSession} found selected
     * by the last call of {@link #select(long)}
     *
     * @return {@link java.util.Iterator} of {@link IoSession} read for I/Os operation
     */
     ...
     * {@link org.apache.mina.core.buffer.IoBuffer}. Is called when the session was found ready for reading.
     *
     * @param session
     *            the session to read
     * @param buf
     ...
     * usual {@link #write(AbstractIoSession, org.apache.mina.core.buffer.IoBuffer, int)} call.
     *
     * @param session
     *            the session to write
     * @param region
