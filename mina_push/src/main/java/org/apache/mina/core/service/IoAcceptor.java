...
public interface IoAcceptor extends IoService {
    ...
    /**
     * Returns a {@link java.util.Set} of the local addresses which are bound currently.
     */
     ...
     * firstly specified address in {@link #setDefaultLocalAddresses(java.util.List)}.
     *
     */
    SocketAddress getDefaultLocalAddress();

    /**
     * Returns a {@link java.util.List} of the default local addresses to bind when no
     ...
     * connections.
     *
     * @throws java.io.IOException if failed to bind
     */
