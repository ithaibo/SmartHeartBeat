 ...
 * <ol>
 * <li>A public constructor with one {@link java.util.concurrent.ExecutorService} parameter.</li>
 * <li>A public constructor with one {@link java.util.concurrent.Executor} parameter.</li>
...
public class SimpleIoProcessorPool<S extends AbstractIoSession> implements IoProcessor<S> {
     ...
     *
     * @param processorType The type of IoProcessor to use
     * @param executor The {@link java.util.concurrent.Executor}
     */
