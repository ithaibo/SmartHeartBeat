 ...
 * cause the {@link IoFilter#filterWrite(IoFilter.NextFilter, IoSession, org.apache.mina.core.write.WriteRequest)}
...
public interface IoSession {
    ...
    /**
     * @return the {@link org.apache.mina.core.service.IoService} which provides I/O service to this session.
     */
    IoService getService();

    /**
     * @return the {@link org.apache.mina.core.service.IoHandler} which handles this session.
     */
    ...
    /**
     * @return the {@link org.apache.mina.core.service.TransportMetadata} that this session runs on.
     */
     ...
     * 
     * @return a {@link org.apache.mina.core.future.ReadFuture} which is notified when a new message is
     ...
     * operation is asynchronous; {@link org.apache.mina.core.service.IoHandler#messageSent(IoSession, Object)}
     * will be invoked when the message is actually sent to remote peer.
     * You can also wait for the returned {@link org.apache.mina.core.future.WriteFuture} if you want
     ...
     * This operation is asynchronous; {@link org.apache.mina.core.service.IoHandler#messageSent(IoSession, Object)}
     * will be invoked when the message is actually sent to remote peer. You can
     * also wait for the returned {@link org.apache.mina.core.future.WriteFuture} if you want to wait for
     ...
     * This interface provides {@link #write(Object, java.net.SocketAddress)} method so you
     ...
     * {@link org.apache.mina.core.future.CloseFuture} if you want to wait for the session actually closed.
     *
    ...
    /**
     * Returns the {@link org.apache.mina.core.future.CloseFuture} of this session.  This method returns
    ...
    /**
     * Returns the socket address of the {@link org.apache.mina.core.service.IoService} listens to to manage
     * this session.  If this session is managed by {@link org.apache.mina.core.service.IoAcceptor}, it
     * returns the {@link java.net.SocketAddress} which is specified as a parameter of
     * {@link org.apache.mina.core.service.IoAcceptor#bind()}.  If this session is managed by
     * {@link org.apache.mina.core.service.IoConnector}, this method returns the same address with
    ...
    /**
     * Returns the message which is being written by {@link org.apache.mina.core.service.IoService}.
     * @return <tt>null</tt> if and if only no message is being written
     */
    Object getCurrentWriteMessage();

    /**
     * Returns the {@link org.apache.mina.core.write.WriteRequest} which is being processed by
     * {@link org.apache.mina.core.service.IoService}.
     *
     * @return <tt>null</tt> if and if only no message is being written
     */
