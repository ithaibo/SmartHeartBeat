...
/**
 * An {@link org.apache.mina.core.filterchain.IoFilter} implementation used to buffer outgoing {@link org.apache.mina.core.write.WriteRequest} almost
 * like what {@link java.io.BufferedOutputStream} does. Using this filter allows to be less dependent
 ...
 *
 * Please note that it should always be placed before the {@link org.apache.mina.filter.codec.ProtocolCodecFilter}
 * as it only handles {@link org.apache.mina.core.write.WriteRequest}'s carrying {@link org.apache.mina.core.buffer.IoBuffer} objects.
 *
...
public final class BufferedWriteFilter extends IoFilterAdapter {
    ...
    /**
     * The map that matches an {@link org.apache.mina.core.session.IoSession} and it's {@link org.apache.mina.core.buffer.IoBuffer}
     * buffer.
     */
     ...
     * bytes. Uses a default instance of {@link java.util.concurrent.ConcurrentHashMap}.
     */
     ...
     * instance of {@link java.util.concurrent.ConcurrentHashMap}.
     *
     ...
     * <code>buffersMap</code> is null then a default instance of {@link java.util.concurrent.ConcurrentHashMap}
     ...
     *                   {@link org.apache.mina.core.buffer.IoBuffer} instance.
     */
    @Override
    ...
    /**
     * Writes an {@link org.apache.mina.core.buffer.IoBuffer} to the session's buffer.
     *
    ...
    /**
     * Writes <code>data</code> {@link org.apache.mina.core.buffer.IoBuffer} to the <code>buf</code>
     * {@link org.apache.mina.core.buffer.IoBuffer} which buffers write requests for the
     ...
     *
     * @param nextFilter the {@link org.apache.mina.core.filterchain.IoFilter.NextFilter} of this filter
     * @param session the session where buffer will be written
    ...
    /**
     * Internal method that actually frees the {@link org.apache.mina.core.buffer.IoBuffer} that contains
