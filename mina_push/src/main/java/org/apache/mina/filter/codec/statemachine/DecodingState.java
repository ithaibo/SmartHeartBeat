...
public interface DecodingState {
    ...
    /**
     * Invoked when the associated {@link org.apache.mina.core.session.IoSession} is closed. This method is
     ...
     * {@link #decode(org.apache.mina.core.buffer.IoBuffer, ProtocolDecoderOutput)} method didn't process
     * completely.
     * 
     * @param out used to write decoded objects.
     * @return the next state if a state transition was triggered (use 
