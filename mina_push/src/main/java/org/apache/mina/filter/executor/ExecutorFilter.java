...
/**
 * A filter that forwards I/O events to {@link java.util.concurrent.Executor} to enforce a certain
 ...
 * to a {@link org.apache.mina.core.filterchain.IoFilterChain}.
 *
 * <h2>Life Cycle Management</h2>
 *
 * Please note that this filter doesn't manage the life cycle of the {@link java.util.concurrent.Executor}.
 * If you created this filter using {@link #ExecutorFilter(java.util.concurrent.Executor)} or similar
 * constructor that accepts an {@link java.util.concurrent.Executor} that you've instantiated, you have
 ...
 * </ul>
 * However, if you specified other {@link java.util.concurrent.Executor} instance in the constructor,
...
public class ExecutorFilter extends IoFilterAdapter {
    ...
    /**
     * Creates a new instance with the specified {@link java.util.concurrent.Executor}.
     *
     ...
     *
     * @param executor The underlying {@link java.util.concurrent.Executor} in charge of managing the Thread pool.
    ...
    /**
     * Returns the underlying {@link java.util.concurrent.Executor} instance this filter uses.
     *
     * @return The underlying {@link java.util.concurrent.Executor}
     */
