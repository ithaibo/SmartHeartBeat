...
/**
 * Attaches an {@link IoEventQueueHandler} to an {@link org.apache.mina.core.session.IoSession}'s
 * {@link org.apache.mina.core.write.WriteRequest} queue to provide accurate write queue status tracking.
 * <p>
 * The biggest difference from {@link OrderedThreadPoolExecutor} and
 * {@link UnorderedThreadPoolExecutor} is that {@link IoEventQueueHandler#polled(Object, org.apache.mina.core.session.IoEvent)}
 * is invoked when the write operation is completed by an {@link org.apache.mina.core.service.IoProcessor},
 * consequently providing the accurate tracking of the write request queue
 * status to the {@link IoEventQueueHandler}.
 * <p>
 * Most common usage of this filter could be detecting an {@link org.apache.mina.core.session.IoSession}
 ...
 * in the {@link org.apache.mina.core.service.IoProcessor} thread.  It's because an {@link org.apache.mina.core.service.IoProcessor}
 * thread is what processes the {@link org.apache.mina.core.write.WriteRequest}s and notifies related
 * {@link org.apache.mina.core.future.WriteFuture}s; the {@link IoEventQueueHandler} implementation that
 ...
 * before this filter or call {@link org.apache.mina.core.session.IoSession#write(Object)} method always
