...
/**
 * An {@link org.apache.mina.core.filterchain.IoFilter} that sends a keep-alive request on
 * {@link org.apache.mina.core.session.IoEventType#SESSION_IDLE} and sends back the response for the
 * sent keep-alive request.
 *
 * <h2>Interference with {@link org.apache.mina.core.session.IoSessionConfig#setIdleTime(org.apache.mina.core.session.IdleStatus, int)}</h2>
 *
 * This filter adjusts <tt>idleTime</tt> of the {@link org.apache.mina.core.session.IdleStatus}s that
 * this filter is interested in automatically (e.g. {@link org.apache.mina.core.session.IdleStatus#READER_IDLE}
 * and {@link org.apache.mina.core.session.IdleStatus#WRITER_IDLE}.)  Changing the <tt>idleTime</tt>
 * of the {@link org.apache.mina.core.session.IdleStatus}s can lead this filter to a unexpected behavior.
 * Please also note that any {@link org.apache.mina.core.filterchain.IoFilter} and {@link org.apache.mina.core.service.IoHandler} behind
 * {@link KeepAliveFilter} will not get any {@link org.apache.mina.core.session.IoEventType#SESSION_IDLE}
 * event.  To receive the internal {@link org.apache.mina.core.session.IoEventType#SESSION_IDLE} event,
 ...
 * </td>
 * <td>Both {@link KeepAliveMessageFactory#getRequest(org.apache.mina.core.session.IoSession)} and
 * {@link KeepAliveMessageFactory#getResponse(org.apache.mina.core.session.IoSession, Object)} must
 ...
 * <td>{@link KeepAliveMessageFactory#getRequest(org.apache.mina.core.session.IoSession)} must return
 * <tt>null</tt> and {@link KeepAliveMessageFactory#getResponse(org.apache.mina.core.session.IoSession, Object)}
 ...
 * {@link KeepAliveMessageFactory#isRequest(org.apache.mina.core.session.IoSession, Object)} and
 * {@link KeepAliveMessageFactory#isResponse(org.apache.mina.core.session.IoSession, Object)} properly
...
public class KeepAliveFilter extends IoFilterAdapter {
     ...
     * <ul>
     * <li><tt>interestedIdleStatus</tt> - {@link org.apache.mina.core.session.IdleStatus#READER_IDLE}</li>
     ...
     * a {@link org.apache.mina.core.session.IoEventType#SESSION_IDLE} event to the next filter.
     ...
     * {@link org.apache.mina.core.session.IoEventType#SESSION_IDLE} event to the next filter.
     * By default, the value of this property is <tt>false</tt>.
     */
    ...
    public void messageReceived(IoFilter.NextFilter nextFilter, IoSession session, Object message) throws Exception {
        Log.i(this.getClass().getSimpleName(), "message received"+android.os.Process.myPid()+'-'+android.os.Process.myTid() + "msg = " + message);
        try {
    ...
    public void sessionIdle(IoFilter.NextFilter nextFilter, IoSession session, IdleStatus status) throws Exception {
        if (status == interestedIdleStatus) {
            if (!session.containsAttribute(WAITING_FOR_RESPONSE)) {
                ...
                if (pingMessage != null) {
                    Log.i(this.getClass().getSimpleName(), "message write"+android.os.Process.myPid()+'-'+android.os.Process.myTid());
