...
/**
 * Filter implementation which makes it possible to write {@link java.io.InputStream}
 * objects directly using {@link org.apache.mina.core.session.IoSession#write(Object)}. When an
 * {@link java.io.InputStream} is written to a session this filter will read the bytes
 * from the stream into {@link org.apache.mina.core.buffer.IoBuffer} objects and write those buffers
 ...
 * {@link java.io.InputStream} written to the session and notifies
 * {@link org.apache.mina.core.future.WriteFuture} on the
 * original {@link org.apache.mina.core.write.WriteRequest}.
 * <p/>
 * This filter will ignore written messages which aren't {@link java.io.InputStream}
 ...
 * care of that in its
 * {@link org.apache.mina.core.service.IoHandler#messageSent(org.apache.mina.core.session.IoSession, Object)}
 * callback.
 * </p>
 *
