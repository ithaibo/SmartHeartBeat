...
/**
 * An {@link org.apache.mina.core.filterchain.IoFilter} that sets initial attributes when a new
 * {@link org.apache.mina.core.session.IoSession} is created.  By default, the attribute map is empty when
 * an {@link org.apache.mina.core.session.IoSession} is newly created.  Inserting this filter will make
...
public class SessionAttributeInitializingFilter extends IoFilterAdapter {
     ...
     * {@link #setAttribute(String, Object)} and {@link #setAttributes(java.util.Map)}.
     */
