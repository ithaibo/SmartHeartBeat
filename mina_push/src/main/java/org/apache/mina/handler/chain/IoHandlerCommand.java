 ...
 * {@link org.apache.mina.core.session.IoSession}.  Individual {@link IoHandlerCommand}s can be assembled into
 ...
 * information in the {@link org.apache.mina.core.session.IoSession} that is passed as a parameter to
 * the {@link #execute(org.apache.mina.handler.chain.IoHandlerCommand.NextCommand, org.apache.mina.core.session.IoSession, Object)} method, using custom
...
public interface IoHandlerCommand {
     ...
     * {@link org.apache.mina.handler.chain.IoHandlerCommand.NextCommand#execute(org.apache.mina.core.session.IoSession, Object)}.
     *
     ...
     * @param session the {@link org.apache.mina.core.session.IoSession} which is associated with
     *                this request
