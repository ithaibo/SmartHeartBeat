...
class NioDatagramSessionConfig extends AbstractDatagramSessionConfig {
     ...
     * @throws org.apache.mina.core.RuntimeIoException if the socket is closed or if we
     ...
     * @throws org.apache.mina.core.RuntimeIoException If the socket is closed or if we get an
